  ...
  public: {
    Tables: {
      ...
      alumni_contact_research: {
        ...
        Relationships: [
          {
            foreignKeyName: "alumni_contact_research_person_id_fkey"
            columns: ["person_id"]
            isOneToOne: true
          ...
          },
          {
            ...
            columns: ["person_id"]
            isOneToOne: true
            referencedRelation: "public_curiosity_profile_details"
            referencedColumns: ["person_id"]
          },
          {
            foreignKeyName: "alumni_contact_research_person_id_fkey"
            columns: ["person_id"]
            isOneToOne: true
            referencedRelation: "public_people_directory"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      checkout_terms_acceptances: {
        ...
        Relationships: [
          {
            foreignKeyName: "checkout_terms_acceptances_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: true
      ...
      contact_research_roster: {
        ...
        Relationships: [
          {
            foreignKeyName: "contact_research_roster_person_id_fkey"
            columns: ["person_id"]
            isOneToOne: true
            referencedRelation: "people"
            referencedColumns: ["id"]
      ...
      content_moderation_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "content_moderation_events_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events"
            referencedColumns: ["id"]
      ...
      photos: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "photos_removed_by_admin_id_fkey"
            columns: ["removed_by_admin_id"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
          },
    ...
    Views: {
      ...
      public_curiosity_profile_details: {
        Row: {
          avatar_url: string | null
          children_count: number | null
          class_group: string | null
    ...
    Functions: {
      ...
      assert_content_moderation_transition: {
        Args: {
      ...
      can_manage_contact_research: { Args: never; Returns: boolean }
      ...
      complete_photo_removal: {
        Args: { p_error?: string; p_request_id: string; p_success: boolean }
        Returns: {
          admin_notes: string | null
          created_at: string
          id: string
      ...
      content_actor_name: { Args: never; Returns: string }
      ...
      get_public_memories: {
        Args: { p_event_id: string; p_featured_only?: boolean }
        Returns: {
          approved_at: string
      ...
      submit_photo_tag: {
        Args: { p_person_id: string; p_photo_id: string; p_tagged_name: string }
        Returns: {
          approved_at: string | null
          approved_by_admin_id: string | null
          created_at: string
