...
| `admin_get_person_details` | `src/lib/services.ts:552` | `AdminGetPersonDetailsArgs` | `AdminGetPersonDetailsReturns` |
...
| `admin_import_people` | `src/lib/services.ts:509` | `AdminImportPeopleArgs` | `AdminImportPeopleReturns` |
| `admin_update_person_and_profile` | `src/lib/services.ts:565` | `AdminUpdatePersonAndProfileArgs` | `AdminUpdatePersonAndProfileReturns` |
...
| `complete_profile_registration_v2` | `src/lib/services.ts:613` | `CompleteProfileRegistrationV2Args` | `CompleteProfileRegistrationV2Returns` |
...
| `get_admin_orders` | `src/lib/services.ts:1039` | `GetAdminOrdersArgs` | `GetAdminOrdersReturns` |
