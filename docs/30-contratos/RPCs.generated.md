...
last_verified_commit: 5ad7de76c55f74cf9e21ca2061b8301f3fb57852
...
| `public.save_contact_research` | `p_person_id uuid, p_whatsapp text, p_instagram text, p_email text, p_notes text, p_source text, p_mark_no_contact boolean` | `alumni_contact_research` | sim | `volatile` | `postgres=X/postgres,authenticated=X/postgres,service_role=X/postgres,anon=X/postgres` |
