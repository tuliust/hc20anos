...
last_verified_commit: 4d93501e2d9f855dee135a38fe22f326cf0e99c3
...
| `forbidden` | `supabase/functions/payment-webhook/index.ts:234` |
...
| `invalid_signature` | `supabase/functions/payment-webhook/index.ts:282`<br>`supabase/functions/server/index.ts:250` |
| `invalid_transaction_amount` | `supabase/functions/payment-webhook/index.ts:191` |
...
| `order_not_found` | `supabase/functions/payment-webhook/index.ts:233`<br>`supabase/functions/payment-webhook/index.ts:274` |
...
| `payment_id_mismatch` | `supabase/functions/payment-webhook/index.ts:176` |
...
| `public_token_mismatch` | `supabase/functions/payment-webhook/index.ts:238` |
...
| `reconciliation_failed` | `supabase/functions/payment-webhook/index.ts:275` |
...
| `temporary_processing_failure` | `supabase/functions/payment-webhook/index.ts:308`<br>`supabase/functions/payment-webhook/index.ts:337` |
