...
| `forbidden` | `supabase/functions/payment-webhook/index.ts:241` |
...
| `invalid_signature` | `supabase/functions/payment-webhook/index.ts:290`<br>`supabase/functions/server/index.ts:250` |
...
| `order_not_found` | `supabase/functions/payment-webhook/index.ts:233`<br>`supabase/functions/payment-webhook/index.ts:282` |
...
| `public_token_mismatch` | `supabase/functions/payment-webhook/index.ts:246` |
...
| `reconciliation_failed` | `supabase/functions/payment-webhook/index.ts:283` |
...
| `temporary_processing_failure` | `supabase/functions/payment-webhook/index.ts:316`<br>`supabase/functions/payment-webhook/index.ts:345` |
