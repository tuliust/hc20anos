...
| `public.checkout_terms_acceptances` | 1 | `id` | `uuid` | NO | `gen_random_uuid()` |
| `public.checkout_terms_acceptances` | 2 | `order_id` | `uuid` | NO | `—` |
| `public.checkout_terms_acceptances` | 3 | `buyer_user_id` | `uuid` | NO | `—` |
| `public.checkout_terms_acceptances` | 4 | `terms_version` | `text` | NO | `—` |
| `public.checkout_terms_acceptances` | 5 | `privacy_version` | `text` | NO | `—` |
| `public.checkout_terms_acceptances` | 6 | `accepted_at` | `timestamp with time zone` | NO | `now()` |
| `public.checkout_terms_acceptances` | 7 | `accepted_via` | `text` | NO | `'checkout_consent'::text` |
| `public.checkout_terms_acceptances` | 8 | `created_at` | `timestamp with time zone` | NO | `now()` |
...
| `public.profiles` | 17 | `show_social_links` | `boolean` | NO | `true` |
...
| `public.checkout_terms_acceptances` | `checkout_terms_acceptances_buyer_user_id_fkey` | `FOREIGN KEY` | `FOREIGN KEY (buyer_user_id) REFERENCES auth.users(id) ON DELETE RESTRICT` |
| `public.checkout_terms_acceptances` | `checkout_terms_acceptances_order_id_fkey` | `FOREIGN KEY` | `FOREIGN KEY (order_id) REFERENCES orders(id) ON DELETE CASCADE` |
| `public.checkout_terms_acceptances` | `checkout_terms_acceptances_order_id_key` | `UNIQUE` | `UNIQUE (order_id)` |
| `public.checkout_terms_acceptances` | `checkout_terms_acceptances_pkey` | `PRIMARY KEY` | `PRIMARY KEY (id)` |
...
| `public.profiles` | `profiles_relationship_to_class_length_check` | `CHECK` | `CHECK (relationship_to_class IS NULL OR char_length(btrim(relationship_to_class)) >= 1 AND char_length(btrim(relationship_to_class)) <= 240)` |
...
| `public.checkout_terms_acceptances` | `checkout_terms_acceptances_buyer_user_id_idx` | `CREATE INDEX checkout_terms_acceptances_buyer_user_id_idx ON public.checkout_terms_acceptances USING btree (buyer_user_id)` |
| `public.checkout_terms_acceptances` | `checkout_terms_acceptances_order_id_key` | `CREATE UNIQUE INDEX checkout_terms_acceptances_order_id_key ON public.checkout_terms_acceptances USING btree (order_id)` |
| `public.checkout_terms_acceptances` | `checkout_terms_acceptances_pkey` | `CREATE UNIQUE INDEX checkout_terms_acceptances_pkey ON public.checkout_terms_acceptances USING btree (id)` |
