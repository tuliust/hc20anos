...
type Metrics = RpcRow<"get_checkin_operation_metrics">;
type ActivityRow = RpcRow<"get_checkin_activity">;
type ExportRow = RpcRow<"export_checkin_report">;
