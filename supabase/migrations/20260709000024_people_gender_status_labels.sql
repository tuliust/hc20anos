-- ================================================================
-- Participantes: gênero administrativo para concordância textual
-- e ajustes de labels públicos/administrativos.
-- ================================================================
...
-- Recria importação admin aceitando gênero opcional.
