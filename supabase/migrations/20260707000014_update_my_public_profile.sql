-- RPC complementar para /editar-perfil.
-- Permite ao usuário vinculado atualizar campos de profiles e campos públicos em people
-- que não pertencem à tabela profiles, como apelido e avatar exibido nos cards.
...
revoke all on function public.update_my_public_profile(text, text, text, text, text, text, text, text, text, text, text, text) from public;
grant execute on function public.update_my_public_profile(text, text, text, text, text, text, text, text, text, text, text, text) to authenticated;
