-- HC 20 Anos — corrige inicialização após consulta idempotente sem resultado.
-- Em PL/pgSQL, SELECT ... INTO sem linhas atribui NULL aos alvos. A função
-- usava v_total e v_expires_at depois dessa consulta, causando total NULL em
-- uma ordem nova com chave de idempotência.
