-- Unifica métricas públicas de presença com o diretório canônico de ex-alunos.
--
-- Regras:
-- - Cadastrados no site: has_completed_registration = true
-- - Eu vou!: intends_to_attend = true AND has_approved_ticket = false
-- - Já compraram: has_approved_ticket = true
--
-- As demais agregações da página de curiosidades continuam baseadas nos
-- perfis cadastrados, preservando o comportamento existente.
