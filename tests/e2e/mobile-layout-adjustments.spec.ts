...
test("seta da Hero usa scroll suave e leva Ã  seÃ§Ã£o seguinte", async ({ page }) => {
...
test("badges DISPONÃVEL e ABERTO ficam em uma linha e acima do tÃ­tulo no mobile", async ({ page }) => {
